...
// Port is considered to be a valid port name, if consists of at most 15 alphanumeric
// characters of which at least one is not a number, as well as non-consecutive dashes
// ('-') except for in the beginning or the end.
// This means that some legal numeric literals are no longer considered numbers, e.g, 0x10 is
// now considered a name rather than number 16.
